...
export const Chat = memo(({ control,dialogMessages, dialogPartnerData, extraActionsUserPhoto,image, imageError, isLoadingChat, lastElRef, message, onClickDelImage, onSendMsgHandler, t, userId }: ChatProps) => {
  return (<>
    ...
    <div className={s.chatBody}>
      <ChatBody control={control} dialogPartner={dialogPartnerData} extraActionsUserPhoto={extraActionsUserPhoto} image={image} imageError={imageError} isLoadingChat={isLoadingChat}
                ...
                onClickDelImage={onClickDelImage}
