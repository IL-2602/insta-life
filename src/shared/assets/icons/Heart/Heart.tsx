...
const SvgComponent = forwardRef<SVGSVGElement, HeartProps>(
  ({ changeIsLikedStatus, commentId = 0, isLiked = false, postId = 0, ...props }, ref) => (
    <svg
      {...props}
      fill={'none'}
      height={12}
      onClick={() => changeIsLikedStatus(commentId, isLiked ? 'DISLIKE' : 'LIKE', postId)}
      ref={ref}
      width={14}
